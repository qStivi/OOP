...
class FishTankTest {
    ...
    void fishTank() {
        ...
        assertThrows(WrongTypeException.class, () -> ft.addCreature(new KeeperLeviathan(5410)));
        assertThrows(WrongTypeException.class, () -> ft.addCreature(new PeaDragonLeviathan(11500)));
        Bellyray bellyray;
        ...
        } catch (WrongTypeException | WrongSizeException e) {
            e.printStackTrace();
        }
    }
}